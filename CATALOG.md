...
| **Just Python** | 🚧 In progress | [`library/in-progress/just-python`](library/in-progress/just-python/CONTEXT.md) | Applied Python (NumPy/Pandas/vectorization; 94% screen, gap-report row 1). **Modules 1–3 shipped** (M1 2026-06-20; M2 "NumPy in Depth" + M3 "Pandas for AI Pipelines" 2026-06-21 — each 5 lessons + 4 exercises, reviewed to STYLE + STANDARDS, `mdbook build` clean). M4 (Vectorization Discipline) next. |
