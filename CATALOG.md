...
| **Only Python** | 🚧 In progress | [`library/in-progress/only-python`](library/in-progress/only-python/CONTEXT.md) | Graduated 2026-06-20 (`GATE-NAME-BOOK` cleared; name + slug locked). Applied Python (NumPy/Pandas/vectorization; 94% screen, gap-report row 1). Blueprint + Chapter 1 preview drafted; plan-locking next at `GATE-LOCK-PLAN`. |
