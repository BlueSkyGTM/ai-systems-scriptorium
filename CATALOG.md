...
| **Just Python** | 🚧 In progress | [`library/in-progress/just-python`](library/in-progress/just-python/CONTEXT.md) | Applied Python (NumPy/Pandas/vectorization; 94% screen, gap-report row 1). **Modules 1–5 shipped** (M1 2026-06-20; M2–M5 "NumPy in Depth", "Pandas for AI Pipelines", "Vectorization Discipline", "Python Idioms at Interview Speed" 2026-06-21 — each 5 lessons + 4 exercises, reviewed to STYLE + STANDARDS, `mdbook build` clean). M6 (Data Wrangling Artifact, the first portfolio module) next. |
