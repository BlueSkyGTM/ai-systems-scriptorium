...
| **Only Python** *(working title)* | 📋 Planned | [`library/planned/just-python`](library/planned/just-python/CONTEXT.md) | Blueprint + Chapter 1 drafted 2026-06-20. Applied Python (NumPy/Pandas/vectorization; 94% screen, gap-report row 1); dive in once Sans Python shows what it is for. Needs `GATE-NAME-BOOK`. |
...
| **Algorithmic Interviewing** *(working title)* | 📋 Planned | [`library/planned/interview-algorithm`](library/planned/interview-algorithm/CONTEXT.md) | Blueprint + Chapter 1 drafted 2026-06-20. The getting-hired book: a reasoning framework, not memorization. Ore: `asdg` interview half. Supersedes Show, Don't Tell's interview angle. Needs `GATE-NAME-BOOK`. |
...
| **Show, Don't Tell** | 📋 Planned | [`library/planned/show-dont-tell`](library/planned/show-dont-tell/CONTEXT.md) | Stub only. Systems-design angle; the interview angle moved to Algorithmic Interviewing. Overlaps Simple Systems; reconcile before starting. Needs `GATE-NAME-BOOK`. |
