...
| **Just Python** | 🚧 In progress | [`library/in-progress/just-python`](library/in-progress/just-python/CONTEXT.md) | Applied Python (NumPy/Pandas/vectorization; 94% screen, gap-report row 1). **Modules 1–6 shipped** (M1 2026-06-20; M2–M5 2026-06-21: "NumPy in Depth", "Pandas for AI Pipelines", "Vectorization Discipline", "Python Idioms at Interview Speed", each 5 lessons + 4 exercises; M6 2026-06-21 "Data Wrangling Artifact", the first portfolio module — a runnable `wrangle.py` + `pytest` smoke gate + skill write-up. Reviewed to STYLE + STANDARDS, `mdbook build` clean). M7 (Evaluation Engine, portfolio) next. |
