...
| **Just Python** | 🚧 In progress | [`library/in-progress/just-python`](library/in-progress/just-python/CONTEXT.md) | Applied Python (NumPy/Pandas/vectorization; 94% screen, gap-report row 1). **Modules 1–2 shipped** (M1 2026-06-20; M2 "NumPy in Depth" 2026-06-21 — each 5 lessons + 4 exercises via the tiered fleet, reviewed to STYLE + STANDARDS, `mdbook build` clean). M3 (Pandas) next. |
