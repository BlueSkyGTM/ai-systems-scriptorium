...
The recruiter is not evaluating depth. She is running a binary filter: does this person know what they do, and does what they describe fit the role? The screen is usually thirty minutes, and the signal she is collecting is whether you can pitch yourself without friction.
...
The dossier piece that prepares this stage is the portfolio-narrative overview, a one-to-two paragraph summary of your strongest artifact that any hiring-stage reader can understand in ninety seconds. Pair it with your Algorithm fluency from the answers log: the recruiter will often ask you to describe your background or walk through what you have done with AI systems, and the answers log gives you the practiced, calibrated language to land that answer cleanly.
...
The systems-design round is the highest-difficulty stage in the loop. The evaluator gives you an open-ended problem, a clock, and very little structure. She is not evaluating whether you have memorized a reference architecture. She is watching how you reason under ambiguity: do you clarify scope before building, do you name the tradeoffs in your choices, do you think about failure modes before she prompts you, and do you connect your design to production constraints?

The failure mode is memorized slides. A candidate who jumps to a solution and recites its components without engaging the problem space fails this round even if the components are correct. What the evaluator hears is that you do not know what you do not know, and that is the signal she is most afraid of.
