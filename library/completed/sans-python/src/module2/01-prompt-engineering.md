...
**Build it in Claude Code** — build a prompt-testing harness that versions three prompt variants in an MLflow registry and scores them against a rubric. Open the repo and run the exercise for this lesson.
