...
[Answer Engineering](README.md)

---

# Module 1: The Framework

- [Overview](module1/00-overview.md)
- [Decompose the Question](module1/decompose-the-question.md)
- [Construct the Answer](module1/construct-the-answer.md)

---

# Module 2: The Algorithm in Detail

- [Overview](module2/00-overview.md)
- [The Question Behind the Question](module2/the-question-behind-the-question.md)
- [Reading the Room](module2/reading-the-room.md)
- [Thinking Out Loud](module2/thinking-out-loud.md)
- [The Weak-Answer Audit](module2/the-weak-answer-audit.md)

---

# Module 3: Behavioral Interviews

- [Overview](module3/00-overview.md)
- [Ownership Stories](module3/ownership-stories.md)
- [Conflict Stories](module3/conflict-stories.md)
- [Failure Stories](module3/failure-stories.md)
- [Influence Stories](module3/influence-stories.md)
...
- [Reading the Design Prompt](module5/reading-the-design-prompt.md)
