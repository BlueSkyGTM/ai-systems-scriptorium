...
<!-- LEAD (1–2 sentences): the problem + why a seam engineer needs this. First sentence earns the second. -->
...
**Try it in Claude Code** — <one-line: what to explore, run, or inspect to make the concept concrete>.
