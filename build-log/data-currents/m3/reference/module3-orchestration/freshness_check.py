"""
freshness_check.py  (copied from M2 reference — do not edit here; the canonical
source is build-log/data-currents/m2/reference/module2-ingestion/freshness_check.py)

Compare each source's last successful load against its SLO.

Public API used by M3:
    check_freshness(db_path, now_ts) -> list[dict]
      Each dict: source_id, last_load_ts, age_hours, max_age_hours, is_stale
"""
