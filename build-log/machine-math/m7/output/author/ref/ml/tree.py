"""Decision tree classifier and regressor, from scratch in NumPy.
...
for classification, and weighted MSE (variance reduction) for regression. The structure is a binary
tree of those choices frozen at fit time.
